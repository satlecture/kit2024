...
\begin{frame}{Instance: Aprove (Termination Analysis)}
    ...
    \only<1>{
        \begin{block}{1000 Conflicts}
        \centering\includegraphics[width=0.9\textwidth, trim={100 0 100 100}, clip]{satviz-aprove-1000}
        \end{block}
    }
    \only<2>{
        \begin{block}{1690 Conflicts}
        \centering\includegraphics[width=0.9\textwidth, trim={100 0 100 100}, clip]{satviz-aprove-1690}
        \end{block}
    }
    \only<3>{
        \begin{block}{3090 Conflicts}
        \centering\includegraphics[width=0.9\textwidth, trim={100 0 100 100}, clip]{satviz-aprove-3090}
        \end{block}
    }
    \only<4>{
        \begin{block}{5000 Conflicts}
        \centering\includegraphics[width=0.9\textwidth, trim={100 0 100 100}, clip]{satviz-aprove-5000}
        \end{block}
    }
    \only<5>{
        \begin{block}{6000 Conflicts (Relayout)}
        \centering\includegraphics[width=0.9\textwidth, trim={100 0 100 100}, clip]{satviz-aprove-6000-relayout}
        \end{block}
    }
    \only<6>{
        \begin{block}{52500 Conflicts (Core)}
        \centering\includegraphics[width=0.9\textwidth, trim={100 0 100 100}, clip]{satviz-aprove-52500-zoom}
        \end{block}
    }
\end{frame}
...
\begin{frame}{Instance: Newton SMT (SV Competition)}
    ...
    \only<1>{
        \begin{block}{}
        \centering\includegraphics[width=0.9\textwidth, trim={100 0 100 100}, clip]{newton-smt-5200}
        \end{block}
    }
    \only<2>{
        \begin{block}{10000 Conflicts (Relayout)}
        \centering\includegraphics[width=0.9\textwidth, trim={100 0 100 100}, clip]{newton-smt-10000}
        \end{block}
    }
    \only<3>{
        \begin{block}{1000000 Conflicts (Relayout)}
        \centering\includegraphics[width=0.9\textwidth, trim={100 0 100 100}, clip]{newton-smt-1000000}
        \end{block}
    }
    \only<4>{
        \begin{block}{3000000 Conflicts (Relayout)}
        \centering\includegraphics[width=0.9\textwidth, trim={100 0 100 30}, clip]{newton-smt-3000000}
        \end{block}
    }
    \only<5>{
        \begin{block}{3500000 Conflicts (Core)}
        \centering\includegraphics[width=0.9\textwidth, trim={100 0 100 100}, clip]{newton-smt-3500000-cherry}
        \end{block}
    }
\end{frame}
